...
if (NOT CLANG_FORMAT-NOTFOUND)
    ...
    list (JOIN FILES "\n" FILE_LIST_CONTENT)
    file (WRITE "${CMAKE_BINARY_DIR}/kan_clang_format_file_list.txt" "${FILE_LIST_CONTENT}")
    ...
    add_custom_target (
            ...
            "--files=${CMAKE_BINARY_DIR}/kan_clang_format_file_list.txt")

    add_custom_target (
            kan_clang_format_fix
            COMMENT "Fix formatting using clang format."
            COMMAND
            "${CLANG_FORMAT}" --style=file -i --Werror "--files=${CMAKE_BINARY_DIR}/kan_clang_format_file_list.txt")
