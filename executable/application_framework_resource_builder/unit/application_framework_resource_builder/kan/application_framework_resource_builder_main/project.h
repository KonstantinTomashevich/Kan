...
#include <application_framework_resource_builder_main_api.h>
...
APPLICATION_FRAMEWORK_RESOURCE_BUILDER_MAIN_API kan_allocation_group_t
...
APPLICATION_FRAMEWORK_RESOURCE_BUILDER_MAIN_API void kan_application_resource_target_init (
    struct kan_application_resource_target_t *instance);

APPLICATION_FRAMEWORK_RESOURCE_BUILDER_MAIN_API void kan_application_resource_target_shutdown (
    struct kan_application_resource_target_t *instance);
...
struct kan_application_resource_project_t
{
    ...
    char *plugin_absolute_directory;
...
APPLICATION_FRAMEWORK_RESOURCE_BUILDER_MAIN_API void kan_application_resource_project_init (
    struct kan_application_resource_project_t *instance);

APPLICATION_FRAMEWORK_RESOURCE_BUILDER_MAIN_API void kan_application_resource_project_shutdown (
    struct kan_application_resource_project_t *instance);
