...
KAN_TEST_CASE (creation)
{
    ...
    KAN_TEST_CHECK (a1 != a2)
    KAN_TEST_CHECK (a1 == kan_allocation_group_get_child (kan_allocation_group_root (), "A1"))
    KAN_TEST_CHECK (a2 == kan_allocation_group_get_child (kan_allocation_group_root (), "A2"))
    ...
    KAN_TEST_CHECK (b1 != b2)
    KAN_TEST_CHECK (b1 == kan_allocation_group_get_child (a1, "B1"))
    KAN_TEST_CHECK (b2 == kan_allocation_group_get_child (a2, "B2"))
}

KAN_TEST_CASE (stack)
{
    KAN_TEST_CHECK (kan_allocation_group_stack_get () == kan_allocation_group_root ())
    kan_allocation_group_t a1 = kan_allocation_group_get_child (kan_allocation_group_root (), "A1");
    kan_allocation_group_t a2 = kan_allocation_group_get_child (kan_allocation_group_root (), "A2");

    kan_allocation_group_stack_push (a1);
    KAN_TEST_CHECK (kan_allocation_group_stack_get () == a1)

    kan_allocation_group_stack_push (a2);
    KAN_TEST_CHECK (kan_allocation_group_stack_get () == a2)
...
KAN_TEST_CASE (group_capture)
{
    ...
    KAN_TEST_CHECK (kan_captured_allocation_group_get_source (capture.captured_root) == kan_allocation_group_root ())
    ...
    for (kan_captured_allocation_group_iterator_t child_iterator =
         ...
         child_iterator != kan_captured_allocation_group_children_end (capture.captured_root);
         child_iterator = kan_captured_allocation_group_children_next (child_iterator))
    {
        ...
        {
            found_a1 = KAN_TRUE;
            KAN_TEST_CHECK (kan_captured_allocation_group_get_source (group) == a1)
        ...
        {
            found_a2 = KAN_TRUE;
            KAN_TEST_CHECK (kan_captured_allocation_group_get_source (group) == a2)
