...
TEST_REFLECTION_API void first_component_init (void *generic_instance);

TEST_REFLECTION_API void first_component_shutdown (void *generic_instance);
...
TEST_REFLECTION_API void second_component_init (void *generic_instance);

TEST_REFLECTION_API void second_component_shutdown (void *generic_instance);
