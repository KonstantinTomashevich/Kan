...
#define TEST_FLOATING_TOLERANCE 0.000001f
    ...
    KAN_TEST_ASSERT (buffer_meta->parameters.size == 3u)
    ...
    parameter_meta =
        &((struct kan_rpl_meta_parameter_t *) buffer_meta->parameters.data)[1u];
    ...
    parameter_meta =
        &((struct kan_rpl_meta_parameter_t *) buffer_meta->parameters.data)[2u];
