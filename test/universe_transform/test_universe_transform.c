...
#define TEST_UTILITY_CHECK_TRANSFORM_GLOBAL(DIMENSIONS)                                                                \
    static inline bool check_transform_global_##DIMENSIONS (struct test_utility_queries_##DIMENSIONS##_t *queries,     \
                                                            kan_universe_object_id_t object_id, bool logical,          \
...
#define TRANSFORM_GLOBAL_TEST(DIMENSIONS)                                                                              \
    ...
    transform_ids[5u] =                                                                                                \
        create_transform_##DIMENSIONS (&state->utility, transform_ids[4u], initial_transform_5, initial_transform_5);  \
                                                                                                                       \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], true, expected_global_transform_3))   \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], true, expected_global_transform_3))   \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[5u], true, expected_global_transform_5))   \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[5u], true, expected_global_transform_5))   \
                                                                                                                       \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], false, expected_global_transform_3))  \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], false, expected_global_transform_3))  \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[5u], false, expected_global_transform_5))  \
    KAN_TEST_CHECK (                                                                                                   \
        check_transform_global_##DIMENSIONS (&state->utility, transform_ids[5u], false, expected_global_transform_5))  \
                                                                                                                       \
    set_transform_local_##DIMENSIONS (&state->utility, transform_ids[2u], transform_local_change_2,                    \
                                      transform_local_change_2);                                                       \
                                                                                                                       \
    KAN_TEST_CHECK (check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], true,                     \
                                                         expected_global_transform_changed_3))                         \
    KAN_TEST_CHECK (check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], true,                     \
                                                         expected_global_transform_changed_3))                         \
    KAN_TEST_CHECK (check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], false,                    \
                                                         expected_global_transform_changed_3))                         \
    KAN_TEST_CHECK (check_transform_global_##DIMENSIONS (&state->utility, transform_ids[3u], false,                    \
                                                         expected_global_transform_changed_3))                         \
                                                                                                                       \
...
#define TRANSFORM_SYNC_VISUAL(DIMENSIONS)                                                                              \
    ...
    case 1000u:                                                                                                        \
        KAN_TEST_CHECK (                                                                                               \
            check_transform_global_##DIMENSIONS (&state->utility, TRANSFORM_SYNC_PARENT_TRANSFORM_ID, false,           \
                                                 make_transform_##DIMENSIONS##_x_only (TRANSFORM_SYNC_BEGIN_X)))       \
                                                                                                                       \
        KAN_TEST_CHECK (check_transform_global_##DIMENSIONS (                                                          \
            &state->utility, TRANSFORM_SYNC_CHILD_TRANSFORM_ID, false,                                                 \
            make_transform_##DIMENSIONS##_x_only (TRANSFORM_SYNC_BEGIN_X * 2.0f)))                                     \
        break;                                                                                                         \
                                                                                                                       \
    case 1100u:                                                                                                        \
        KAN_TEST_CHECK (check_transform_global_##DIMENSIONS (                                                          \
            &state->utility, TRANSFORM_SYNC_PARENT_TRANSFORM_ID, false,                                                \
