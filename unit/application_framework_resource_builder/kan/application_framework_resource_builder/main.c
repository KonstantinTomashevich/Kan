...
int main (int argument_count, char **argument_values)
{
    ...
    if (result == 0)
    {
        ...
        kan_file_system_path_container_append (&source_directory, global.project.output_directory);
        ...
        kan_file_system_path_container_append (&source_directory, global.project.reference_cache_directory);
    ...
    if (result == 0)
    {
...

        {
            ...
            if (global.project_directory_path_end)
            {
                kan_file_system_path_container_copy_char_sequence (&configuration_path, global.project_directory_path,
                                                                   global.project_directory_path_end);
            }
            else
            {
                kan_file_system_path_container_reset_length (&configuration_path, 0u);
            }

            kan_file_system_path_container_append (&configuration_path, global.project.platform_configuration);
