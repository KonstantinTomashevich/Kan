...
C_INTERFACE_API void kan_c_interface_init_enums_array (struct kan_c_interface_t *interface, kan_instance_size_t count);

/// \brief Utility for initializing structures array in interface.
/// \details Aimed to be used inside `c_interface`, but is allowed to be used outside.
C_INTERFACE_API void kan_c_interface_init_structs_array (struct kan_c_interface_t *interface,
                                                         kan_instance_size_t count);

/// \brief Utility for initializing functions array in interface.
/// \details Aimed to be used inside `c_interface`, but is allowed to be used outside.
C_INTERFACE_API void kan_c_interface_init_functions_array (struct kan_c_interface_t *interface,
                                                           kan_instance_size_t count);

/// \brief Utility for initializing symbols array in interface.
/// \details Aimed to be used inside `c_interface`, but is allowed to be used outside.
C_INTERFACE_API void kan_c_interface_init_symbols_array (struct kan_c_interface_t *interface,
                                                         kan_instance_size_t count);

/// \brief Utility for initializing values array in enumeration.
/// \details Aimed to be used inside `c_interface`, but is allowed to be used outside.
C_INTERFACE_API void kan_c_enum_init_values_array (struct kan_c_enum_t *enum_info, kan_instance_size_t count);

/// \brief Utility for initializing fields array in structure.
/// \details Aimed to be used inside `c_interface`, but is allowed to be used outside.
C_INTERFACE_API void kan_c_struct_init_fields_array (struct kan_c_struct_t *struct_info, kan_instance_size_t count);

/// \brief Utility for initializing arguments array in function.
/// \details Aimed to be used inside `c_interface`, but is allowed to be used outside.
C_INTERFACE_API void kan_c_function_init_arguments_array (struct kan_c_function_t *function_info,
                                                          kan_instance_size_t count);
