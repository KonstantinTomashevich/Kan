...
static inline struct render_backend_classic_graphics_pipeline_family_t *
...
static inline void render_backend_system_destroy_classic_graphics_pipeline_family (
    struct render_backend_system_t *system,
    struct render_backend_classic_graphics_pipeline_family_t *family,
    kan_bool_t remove_from_list)
{
