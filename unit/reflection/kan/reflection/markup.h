...
#define KAN_REFLECTION_EXPLICIT_INIT_FUNCTOR(FUNCTION_NAME)                                                            \
    KAN_MAKE_PRAGMA (kan_reflection_explicit_init_functor FUNCTION_NAME)
...
#define KAN_REFLECTION_DYNAMIC_ARRAY_TYPE(TYPE) KAN_MAKE_PRAGMA (kan_reflection_dynamic_array_type TYPE)
...
#define KAN_REFLECTION_VISIBILITY_CONDITION_VALUE(VALUE)                                                               \
    KAN_MAKE_PRAGMA (kan_reflection_visibility_condition_value VALUE)

/// \brief Marks next symbol as meta for enum with given name.
#define KAN_REFLECTION_ENUM_META(ENUM_NAME) KAN_MAKE_PRAGMA (kan_reflection_enum_meta ENUM_NAME)
...
#define KAN_REFLECTION_STRUCT_META(STRUCT_NAME) KAN_MAKE_PRAGMA (kan_reflection_struct_meta STRUCT_NAME)
