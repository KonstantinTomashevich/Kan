...
/// \invariant Target points to freshly allocated and initialized struct, otherwise old data will be leaked.
/// \invariant There is no fields of KAN_REFLECTION_ARCHETYPE_EXTERNAL_POINTER and
///            KAN_REFLECTION_ARCHETYPE_STRUCT_POINTER archetypes.
...
/// \invariant There is no KAN_REFLECTION_ARCHETYPE_STRING_POINTER, KAN_REFLECTION_ARCHETYPE_EXTERNAL_POINTER,
///            KAN_REFLECTION_ARCHETYPE_STRUCT_POINTER and KAN_REFLECTION_ARCHETYPE_PATCH as it is not entirely
///            obvious what to do with them: deallocate them or leave them be.
