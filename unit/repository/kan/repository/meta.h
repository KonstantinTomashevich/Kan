...
{
    kan_instance_size_t reflection_path_length;
...
{
    const char *event_type;
    kan_instance_size_t observed_fields_count;
    struct kan_repository_field_path_t *observed_fields;
    kan_instance_size_t unchanged_copy_outs_count;
    struct kan_repository_copy_out_t *unchanged_copy_outs;
    kan_instance_size_t changed_copy_outs_count;
