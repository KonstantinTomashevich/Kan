...
struct single_pipeline_scheduler_state_t
{
...
UNIVERSE_SINGLE_PIPELINE_SCHEDULER_API void single_pipeline_scheduler_state_init (
    struct single_pipeline_scheduler_state_t *instance)
{
...
UNIVERSE_SINGLE_PIPELINE_SCHEDULER_API KAN_UM_SCHEDULER_EXECUTE (single_pipeline)
{
...
struct single_pipeline_no_time_scheduler_state_t
{
    kan_interned_string_t pipeline_name;
};

UNIVERSE_SINGLE_PIPELINE_SCHEDULER_API void single_pipeline_no_time_scheduler_state_init (
    struct single_pipeline_no_time_scheduler_state_t *instance)
{
    instance->pipeline_name = kan_string_intern (KAN_UNIVERSE_SINGLE_PIPELINE_SCHEDULER_PIPELINE_NAME);
}

UNIVERSE_SINGLE_PIPELINE_SCHEDULER_API KAN_UM_SCHEDULER_EXECUTE (single_pipeline_no_time)
{
    kan_universe_scheduler_interface_run_pipeline (interface, state->pipeline_name);
    kan_universe_scheduler_interface_update_all_children (interface);
}
